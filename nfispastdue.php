...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="nav-link text-dark" href="nfispastdue.php"><b>PastDue </b><span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
    ...
    <div class="col-5 text-right">
      <font size="1px">FILE:&nbsp<a href="file/updates.xls" target="_blank">UPDATE</a>|<a href="file/amend.xls" target="_blank">AMEND</a>|&nbsp<a href="file/deletion.xls" target="_blank">DELETION</a></font>
    </div>
  </div>
<form>
      ...
      <tr style="line-height: 8px" class=" text-dark text-center">
        ...
        <td class="table-success text-dark" width="8%"  class=""><font size="1px">PastDueAmount</font></td>
        <td class="table-success text-dark" width="7%"  class=""><font size="1px">PastDueDate</font></td>
    ...
    <tbody>
      <?php
          ...
          $sql="SELECT nfis.ReportingBranch,
                        ...
                        nfis.PastDueAmount,
                        FORMAT(nfis.PastDueDate,'MM/dd/yyyy') PastDueDate,
