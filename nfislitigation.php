      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item active">
            <a class="nav-link text-dark" href="nfislitigation.php"><b>Items In Litigation  <span class="sr-only">(current)</span></b></a>
          </li>
          <li class="nav-item">
    ...
    <tbody>
      <?php
          ...
          $sql="SELECT nfis.ReportingBranch,
                        ...
                        nfis.OSBalance,
                        FORMAT(nfis.MaturityDate,'MM-dd-yyyy') PastDueDate,
